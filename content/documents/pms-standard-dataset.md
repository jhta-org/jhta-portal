...
description: "観光庁事業の成果物を活用し、宿泊業のデータ標準化の取組を推進していくために整理した標準データセット。6カテゴリ・252データ項目＋41種コードリストを定義し、OpenTravel Alliance・TravelXML・GIF・HTNG等の国内外主要仕様との対応関係を整理しています。"
category: "データ標準"
wg: "データ標準化WG"
status: "public"
files:
